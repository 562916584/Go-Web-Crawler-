...
type ConcurrentEngineCreator struct {
}

func (this *ConcurrentEngineCreator) Create() model.Entity {
	s := new(ConcurrentEngine)
	return s
}

func (this *ConcurrentEngine) Prepare(itemChan chan Item, scheduler Scheduler,
	count int, requestProcessor Processor) {
